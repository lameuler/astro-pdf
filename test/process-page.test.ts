    ...
    describe('valid page full test', () => {
        ...
        describe('parse pdf', () => {
            ...
            test('pdf content', () => {
                ...
                expect(allText).toContain('@test/process-page')
                expect(allText).toContain('[added by script.js]')
                expect(allText).toContain(injectedText)
                expect(allText).toContain('@media screen')
            })
        })
    })
